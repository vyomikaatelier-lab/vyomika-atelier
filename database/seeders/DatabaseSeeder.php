...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedCatalog(): void
    {
        ...
        foreach ($categories as $index => $cat) {
            Category::create([...$cat, 'sort_order' => $index + 1, 'is_active' => true]);
        }
        ...
        $products = array_values($productsBySlug);
        ...
        foreach ($services as $data) {
            ...
            foreach ($designs as $design) {
                ServiceDesign::create([...$design, 'service_id' => $service->id, 'is_active' => true]);
            }
        }
