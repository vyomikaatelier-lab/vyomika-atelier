...
return (function () {
    ...
    return [
        ...
        ['name' => 'Rose Gold Room Divider', 'slug' => 'rose-gold-room-divider', 'category' => 'room-dividers', 'price' => 32999, 'compare_price' => 42999, 'sku' => 'SSM-RG-003', 'featured' => true, 'image' => $images[2], 'desc' => 'Statement rose gold PVD room divider for retail and residences.'],
