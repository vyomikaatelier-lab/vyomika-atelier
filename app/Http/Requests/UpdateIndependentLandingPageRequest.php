...
class UpdateIndependentLandingPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cards.*.meta_title' => 'nullable|string|max:255',
            'cards.*.meta_description' => 'nullable|string|max:500',
            'cards.*.og_title' => 'nullable|string|max:255',
            'cards.*.og_description' => 'nullable|string|max:500',
            'cards.*.og_image' => 'nullable|string|max:2048',
            'cards.*.canonical_url' => 'nullable|string|max:500',
            'cards.*.seo_keyword' => 'nullable|string|max:120',
            'cards.*.robots_index' => 'nullable',
            ...
            'apps.*.meta_title' => 'nullable|string|max:255',
            'apps.*.meta_description' => 'nullable|string|max:500',
            'apps.*.og_title' => 'nullable|string|max:255',
            'apps.*.og_description' => 'nullable|string|max:500',
            'apps.*.og_image' => 'nullable|string|max:2048',
            'apps.*.canonical_url' => 'nullable|string|max:500',
            'apps.*.seo_keyword' => 'nullable|string|max:120',
            'apps.*.robots_index' => 'nullable',
