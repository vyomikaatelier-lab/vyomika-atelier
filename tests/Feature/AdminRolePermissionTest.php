...
class AdminRolePermissionTest extends TestCase
{
    ...
    public function test_owner_sees_editable_switches_and_non_owner_cannot_update(): void
    {
        ...
        $ownerPage->assertOk()
            ...
            ->assertSee('data-switch-role="Owner"', false)
            ->assertSee('data-switch-permission="Manage staff &amp; roles"', false)
            ->assertSee('data-switch-lock="Required for the Owner role and cannot be turned off."', false)
    ...
    public function test_staff_page_shows_one_selected_role_permission_set_at_a_time(): void
    {
        ...
        $viewerPage->assertOk()
            ...
            ->assertSee('data-switch-role="Viewer"', false)
            ->assertSee('data-switch-permission="View orders"', false)
            ->assertSee('data-switch-lock="Only the Owner can manage staff, invitations and role access."', false)
