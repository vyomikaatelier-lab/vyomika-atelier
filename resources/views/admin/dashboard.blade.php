...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
    ...
    <a href="{{ route('admin.leads.index') }}" class="bg-white p-5 rounded-lg shadow hover:ring-2 hover:ring-gray-200"><p class="text-sm text-gray-500">New leads</p><p class="text-2xl font-semibold">{{ $stats['new_leads'] }}</p></a>
