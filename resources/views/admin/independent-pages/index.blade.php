...
<p class="text-sm text-gray-600 mb-4">Edit hero, intro, and SEO for Railings and Corten Steel landing pages (separate from product categories).</p>
<table class="w-full bg-white rounded-lg shadow text-sm">
    ...
    <tbody>
        ...
        <tr class="border-b">
            ...
            <td class="p-3"><a href="{{ route('admin.independent-pages.edit', $page['slug']) }}" class="text-blue-600">Edit</a></td>
        </tr>
        @endforeach
    </tbody>
</table>
